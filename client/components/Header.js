...
export default class Header extends React.Component{
  ...
  render(){
    return(
      <View style={{paddingTop: STATUSBAR_HEIGHT, backgroundColor: '#FFCA28'}}>
        <TouchableOpacity style={{alignItems: 'center', margin: 8, flexDirection: 'row', justifyContent: 'flex-end'}}>
